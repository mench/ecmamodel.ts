...
var Model = (function (_super) {
    ...
    Object.defineProperty(Model.prototype, "index", {
        get: function () {
            return this.constructor[field_3.INDEX];
        },
        enumerable: true,
        configurable: true
    });
    ...
    Model.prototype.register = function () {
        ...
        var mapper = field_2.mappings.get(this.constructor) || new schema_1.Schema();
        var props = mapper.fields;
    ...
    Model.prototype.save = function (options, httpOpt) {
        var _this = this;
        if (options === void 0) { options = { validate: true }; }
        if (httpOpt === void 0) { httpOpt = {}; }
        var sync = function () {
            var save = function () {
                if (_this.isNew) {
                    return _this.sync.create(httpOpt).then(function (res) {
                        return _this.set(res);
                    });
                }
                return _this.sync.update(httpOpt).then(function (res) {
                    return _this.set(res);
                });
            };
    ...
    Model.prototype.destroy = function (options) {
        ...
        return this.sync.delete(options).then(function (res) {
