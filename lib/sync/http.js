...
var SyncHttp = (function (_super) {
    ...
    SyncHttp.prototype.create = function (options) {
        if (options === void 0) { options = {}; }
        return fetch(this.entity.url, objects_1.Objects.merge(options, {
            method: "POST",
            body: this.encode(),
            headers: {
    ...
    SyncHttp.prototype.update = function (options) {
        if (options === void 0) { options = {}; }
        return fetch(this.entity.url + "/" + (this.entity[this.entity.index] ? this.entity[this.entity.index] : ''), objects_1.Objects.merge(options, {
            method: "PUT",
            body: this.encode(),
            headers: {
                "Content-Type": "application/json"
    ...
    SyncHttp.prototype.read = function (options) {
        ...
        return fetch(url, objects_1.Objects.merge(options, params)).then(this.resolve, function (e) {
            return Promise.reject(e);
        });
    };
    SyncHttp.prototype.delete = function (options) {
        if (options === void 0) { options = {}; }
        return fetch(this.entity.url + "/" + (this.entity[this.entity.index] ? this.entity[this.entity.index] : ''), objects_1.Objects.merge(options, {
            method: "DELETE",
            body: this.encode(),
